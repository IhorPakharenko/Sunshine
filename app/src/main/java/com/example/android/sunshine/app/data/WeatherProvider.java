...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(authority, path, WEATHER);
        uriMatcher.addURI(authority, path + "/*", WEATHER_WITH_LOCATION);
        uriMatcher.addURI(authority, path + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
